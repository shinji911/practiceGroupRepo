...
import com.awsome.MotoInvEdge.exception.ItemNotFoundException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<VndErrors> notFoundException(ItemNotFoundException e, WebRequest request) {
